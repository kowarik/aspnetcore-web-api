...
namespace my_books_tests
{
    public class PublishersServiceTest
    {
        ...
        public void GetAllPublishers_WithNoSortBy_WithNoSearchString_WithNoPageNumber_Test()
        {
            ...
            Assert.That(result.Count, Is.EqualTo(5)); //5 т.к всего 5 паблишеров на странице
            //Assert.AreEqual(result.Count, 5); // аналогично предыдущему
        }
        ...
        public void GetAllPublishers_WithNoSortBy_WithNoSearchString_WithPageNumber_Test()
        {
            ...
            Assert.That(result.Count, Is.EqualTo(1)); //1 т.к будет 1 паблишер на 2й странице
        }
        ...
        public void GetAllPublishers_WithNoSortBy_WithSearchString_WithNoPageNumber_Test()
        {
            ...
            Assert.That(result.Count, Is.EqualTo(1)); //1 т.к будет 1 паблишер 3
        ...
        public void GetAllPublishers_WithSortBy_WithNoSearchString_WithNoPageNumber_Test()
        {
            ...
            Assert.That(result.Count, Is.EqualTo(5)); //1 т.к будет 5 паблишеров на 1й странице
            Assert.That(result.FirstOrDefault().Name, Is.EqualTo("Publisher 6")); //т.к первый в сортировке будет паблишер 6
        }
        ...
        public void AddPublisher_WithoutException_Test()
        {
            ...
            Assert.That(result.Name, Does.StartWith("Test"));
        }

        [Test, Order(9)]
        public void GetPublisherData_Test()
        {
            var result = publishersService.GetPublisherDataById(1);
        ...
        public void DeletePublisherById_PublisherDoesNotExists_Test()
        {
            ...
            Assert.That(() => publishersService.DeletePublisherById(publisherId), 
                Throws.Exception.TypeOf<Exception>().With.Message.EqualTo($"The publisher with id: {publisherId} does not exist"));
        }
